...
import {
  ...
  PERF_UPDATE_SEC,
  ClusterStatsStatus,
} from "../explorer/providers/stats/solanaClusterStats";
import classNames from "classnames";
import { TableCardBody } from "../explorer/components/common/TableCardBody";
import { ChartOptions, ChartTooltipModel } from "chart.js";
import { PerformanceInfo } from "../explorer/providers/stats/solanaPerformanceInfo";
import { StatsNotReady } from "../explorer/pages/ClusterStatsPage";

export function SmallTpsCard() {
  return (
    <div className="card-transaction">
      <div className="card-transaction-header">
    ...
    <>
      {/* <TableCardBody>
        <tr className="tr-header">
          <td className="live-transaction">Transaction count</td>
          <td className="live-transaction">{transactionCount} </td>
        </tr>
        <tr>
          <td className="live-transaction">Transactions per second (TPS)</td>
          <td className="live-transaction">{averageTps} </td>
        </tr>
      </TableCardBody> */}
      <div>
        <div className="explorer-label">
          <span>Transaction count</span> <span>{transactionCount}</span>
        </div>
        <div className="explorer-label">
          {" "}
          <span>Transactions per second (TPS)</span> <span>{averageTps}</span>
        </div>
      </div>
      {/* <hr className="my-0" /> */}
