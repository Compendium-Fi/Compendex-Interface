...
import {
  ...
  LoaderName,
  programLabel,
} from "../explorer/utils/tx";
import { Cluster, useCluster } from "../explorer/providers/cluster";
      ...
      options: [
        {
          label: `Slot #${search}`,
          value: [search],
          pathname: `/explorer/block/${search}`,
        },
      ],
    });
  }
        ...
        options: [
          {
            label: search,
            value: [search],
            pathname: "/explorer/address/" + search,
          },
        ],
      });
