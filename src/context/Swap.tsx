...
export function SwapContextProvider(props: any) {
  ...
  // console.log("FROOOOM", fromMint.toBase58());
  // console.log("TOOOO", toMint.toBase58());
  ...
  const setToAmount = (amount: number) => {
    ...
    // console.log("Fee multiplier",FEE_MULTIPLIER) ;
...
function _useSwapFair(
  ...
  const fair = fairOverride === null ? 0 : fairOverride;
  return fair;
}
